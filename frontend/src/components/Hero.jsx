...
const Hero = () => {
	return (
		...
		<div className="pt-8">
			<div className="py-16 px-10 bg-hero-pattern bg-no-repeat bg-cover md:h-[40rem] ">
		...
		<div className="">
			<div className="py-16 px-10 bg-hero-pattern bg-no-repeat bg-cover h-[40rem] ">
				...
				<div className="pt-8 flex gap-2 font-bold">
					<button className="bg-blue-900 hover:bg-yellow-400 rounded p-3 text-white transition-all">
						<Link to="/mentor-register">
							Become a Mentor
						</Link>
					</button>
					<button className="bg-yellow-400 rounded p-3 text-blue-900 transition-all">
